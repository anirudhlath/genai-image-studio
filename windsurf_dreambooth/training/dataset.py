...
class DreamBoothDataset(Dataset):
    ...
    def _create_transform(self, training: bool = True, random_flip: bool = True, color_jitter: bool = True):
        """Create image transformation pipeline."""
        transform_list = []
        
        # Resize with aspect ratio preservation
        transform_list.append(transforms.Resize(self.size, interpolation=transforms.InterpolationMode.BILINEAR))
    ...
    def __getitem__(self, index: int) -> dict:
        ...
        instance_image = self._load_and_transform_image(
            self.instance_images[instance_index],
